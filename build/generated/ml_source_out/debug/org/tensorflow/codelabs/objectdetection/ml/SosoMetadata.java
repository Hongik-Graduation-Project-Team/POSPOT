...
public final class SosoMetadata {
  @NonNull
  ...
  private SosoMetadata(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "soso_metadata.tflite", options);
  ...
  @NonNull
  public static SosoMetadata newInstance(@NonNull Context context) throws IOException {
    return new SosoMetadata(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static SosoMetadata newInstance(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    return new SosoMetadata(context, options);
  }
